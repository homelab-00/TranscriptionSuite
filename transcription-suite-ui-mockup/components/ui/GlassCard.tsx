...
export const GlassCard: React.FC<GlassCardProps> = ({ children, className = '', title, action }) => {
  return (
    <div className={`bg-gradient-to-br from-glass-200 to-glass-100 backdrop-blur-xl border border-glass-border rounded-2xl shadow-xl overflow-hidden flex flex-col ${className}`}>
      {(title || action) && (
