...
class ConfigurationDialog:
            ...
            for model_dir in model_dirs:
                ...
                if "whisper" in model_dir.lower():
                    ...
                    if norm_name not in normalized_models:
                        ...
                        models.append(
                            norm_name
                        )  # Use normalized name instead of directory name
    ...
    def show_dialog(self):
        ...
        longform_tab = self._create_scrollable_tab(
            notebook, bg_color, button_bg
        )
        realtime_tab = self._create_scrollable_tab(
            notebook, bg_color, button_bg
        )
    ...
    class ScrollableFrame(tk.Frame):
        ...
        def __init__(
            self, container, bg_color, button_bg=None, *args, **kwargs
        ):
    ...
    def _create_tab_content(
        ...
        model_frame = self._create_section(
            tab, "Model", bg_color, text_color, entry_bg, highlight_color
        )
        model_frame.pack(fill="x", pady=5)

        models = self._get_available_models()
        current_model = self.config[section].get(
        ...
        language_frame = self._create_section(
            tab, "Language", bg_color, text_color, entry_bg, highlight_color
        )
        ...
        listbox_scrollbar = tk.Scrollbar(
            listbox_container, bg=button_bg, troughcolor=bg_color
        )
        ...
        for param, value in self.config[section].items():
            ...
            param_frame = self._create_section(
                tab, param, bg_color, text_color, entry_bg, highlight_color
            )
        ...
        if section == "longform":
            ...
            send_enter_frame = self._create_section(
                tab,
                "Send Enter After Typing (Placeholder)",
                bg_color,
                text_color,
                entry_bg,
                highlight_color,
    ...
    def _create_section(
        self, parent, title, bg_color, text_color, entry_bg, highlight_color
    ):
