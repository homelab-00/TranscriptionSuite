...
class LongFormTranscriber:
    ...
    def _initialize_recorder(self):
        ...
        try:
            ...
            if has_rich:
                console.print(
                    "[bold green]Real-time transcription system initialized.[/bold green]"
                )
            else:
    ...
    def start(self):
        ...
        if not self._initialize_recorder():
            if has_rich:
                console.print(
                    "[bold red]Failed to initialize the recorder. Cannot start transcription.[/bold red]"
                )
            else:
                print(
        ...
        if has_rich:
            console.print(
                "[bold green]Real-time transcription active[/bold green]"
            )
        else:
        ...
        try:
            while self.running:
                try:
                    ...
                    if has_rich:
                        console.print(
                            f"[bold red]Error during transcription: {str(e)}[/bold red]"
                        )
                    else:
    ...
    def stop(self):
        ...
        if self.recorder:
            try:
                ...
                if has_rich:
                    console.print(
                        f"[bold red]Error during shutdown: {str(e)}[/bold red]"
                    )
                else:
