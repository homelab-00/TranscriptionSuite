...
export const MODEL_REGISTRY: ModelInfo[] = [
  ...
  // ── MLX VibeVoice (Apple Silicon / Metal) ────────────────────────────────
  {
    ...
    family: 'mlx',
    description:
      'Microsoft VibeVoice-ASR on MLX, Q4 quantised. Native diarization + timestamps on Apple Silicon. Smallest VibeVoice variant (~5.7 GB). Maximum supported audio length is 59 minutes; longer recordings are automatically trimmed.',
    parameterCount: '9B',
  ...
  },
  {
    ...
    family: 'mlx',
    description:
      'Microsoft VibeVoice-ASR on MLX, Q8 quantised. Native diarization + timestamps on Apple Silicon (~9.5 GB). Maximum supported audio length is 59 minutes; longer recordings are automatically trimmed.',
    parameterCount: '9B',
  ...
  },
  {
    ...
    family: 'mlx',
    description:
      'Microsoft VibeVoice-ASR on MLX. Native diarization + timestamps on Apple Silicon. Full precision (~18 GB). Maximum supported audio length is 59 minutes; longer recordings are automatically trimmed.',
    parameterCount: '9B',
  ...
  // beats the 1.1b on all English benchmarks.
  {
    ...
    family: 'mlx',
    description:
      'NVIDIA Parakeet-TDT 0.6B v3 on MLX. SOTA accuracy on Apple Silicon — 660K hours of training, native punctuation & capitalisation, 25 European languages (~1.1 GB). Automatically switches to local (sliding-window) attention for audio longer than 30 seconds, keeping Metal memory usage bounded for arbitrarily long recordings.',
    parameterCount: '600M',
  ...
  // No translation support in the MLX port (ASR only).
  {
    ...
    family: 'mlx',
    description:
      'NVIDIA Canary 1B v2 on MLX. ~8.5× real-time on Apple Silicon, native P&C, 25 European languages (~3.7 GB). Audio is processed in VAD-based chunks of up to 30 seconds; arbitrarily long recordings are handled safely.',
    parameterCount: '1B',
  ...
  },
  {
    ...
    family: 'mlx',
    description:
      'NVIDIA Canary 1B v2 on MLX, Q8 quantised. Native P&C, 25 European languages (~1.1 GB). Audio is processed in VAD-based chunks of up to 30 seconds; arbitrarily long recordings are handled safely.',
    parameterCount: '1B',
  ...
  // ── MLX Whisper (Apple Silicon / Metal via mlx-audio) ───────────────────
  {
    ...
    family: 'mlx',
    description:
      'Fast turbo variant of Whisper large-v3 on Apple Silicon. Best speed/accuracy tradeoff (~1.6 GB). Audio is processed in 30-second sliding windows; arbitrarily long recordings are handled safely.',
    parameterCount: '809M',
  ...
  },
  {
    ...
    family: 'mlx',
    description:
      'Fast turbo variant of Whisper large-v3 on Apple Silicon. Q8 quantized — smaller footprint with minimal quality loss (~0.8 GB). Audio is processed in 30-second sliding windows; arbitrarily long recordings are handled safely.',
    parameterCount: '809M',
  ...
  },
  {
    ...
    family: 'mlx',
    description:
      'Fast turbo variant of Whisper large-v3 on Apple Silicon. Q4 quantized — lowest memory usage (~0.4 GB). Audio is processed in 30-second sliding windows; arbitrarily long recordings are handled safely.',
    parameterCount: '809M',
  ...
  },
  {
    ...
    family: 'mlx',
    description: 'Whisper large-v3 on Apple Silicon. Highest accuracy (~3 GB). Audio is processed in 30-second sliding windows; arbitrarily long recordings are handled safely.',
    parameterCount: '1.5B',
  ...
  },
  {
    ...
    family: 'mlx',
    description:
      'Whisper large-v3 on Apple Silicon. Q8 quantized — smaller footprint with minimal quality loss (~1.5 GB). Audio is processed in 30-second sliding windows; arbitrarily long recordings are handled safely.',
    parameterCount: '1.5B',
  ...
  },
  {
    ...
    family: 'mlx',
    description:
      'Whisper large-v3 on Apple Silicon. Q4 quantized — lowest memory usage (~0.75 GB). Audio is processed in 30-second sliding windows; arbitrarily long recordings are handled safely.',
    parameterCount: '1.5B',
  ...
  },
  {
    ...
    family: 'mlx',
    description: 'Lightweight Whisper small on Apple Silicon (~0.5 GB). Audio is processed in 30-second sliding windows; arbitrarily long recordings are handled safely.',
    parameterCount: '244M',
  ...
  },
  {
    ...
    family: 'mlx',
    description: 'Lightweight Whisper small on Apple Silicon. Q8 quantized (~0.24 GB). Audio is processed in 30-second sliding windows; arbitrarily long recordings are handled safely.',
    parameterCount: '244M',
  ...
  },
  {
    ...
    family: 'mlx',
    description:
      'Lightweight Whisper small on Apple Silicon. Q4 quantized — smallest footprint (~0.12 GB). Audio is processed in 30-second sliding windows; arbitrarily long recordings are handled safely.',
    parameterCount: '244M',
  ...
  },
  {
    ...
    family: 'mlx',
    description: 'Smallest Whisper model on Apple Silicon. Fastest but lowest accuracy (~78 MB). Audio is processed in 30-second sliding windows; arbitrarily long recordings are handled safely.',
    parameterCount: '39M',
  ...
  },
  {
    ...
    family: 'mlx',
    description: 'Smallest Whisper model on Apple Silicon. Q8 quantized (~39 MB). Audio is processed in 30-second sliding windows; arbitrarily long recordings are handled safely.',
    parameterCount: '39M',
  ...
  },
  {
    ...
    family: 'mlx',
    description:
      'Smallest Whisper model on Apple Silicon. Q4 quantized — minimal memory usage (~20 MB). Audio is processed in 30-second sliding windows; arbitrarily long recordings are handled safely.',
    parameterCount: '39M',
