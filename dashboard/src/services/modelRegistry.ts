...
export interface ModelInfo {
  ...
  capabilities: {
    /** 'multilingual' = translates between languages (A⇄B); 'toEnglish' = foreign audio → English only */
    translation: 'none' | 'toEnglish' | 'multilingual';
    liveMode: boolean;
    diarization: boolean;
...
export const MODEL_REGISTRY: ModelInfo[] = [
  // ── NeMo ─────────────────────────────────────────────────────────────────
  {
    ...
    capabilities: { translation: 'none', liveMode: false, diarization: false, languageCount: 25 },
    roles: ['main'],
  ...
  // ── SenseVoice (FunASR) ──────────────────────────────────────────────────
  {
    ...
    capabilities: { translation: 'none', liveMode: false, diarization: true, languageCount: 5 },
    roles: ['main'],
    requiresRuntime: 'cuda',
  },
  ...
  },
  {
    ...
    capabilities: { translation: 'none', liveMode: true, diarization: false, languageCount: 99 },
    roles: ['main', 'live'],
    requiresRuntime: 'cuda',
  },
  {
  ...
  },
  {
    ...
    capabilities: { translation: 'none', liveMode: true, diarization: false, languageCount: 1 },
    roles: ['main', 'live'],
    requiresRuntime: 'cuda',
  },
  {
  ...
  // ── VibeVoice ────────────────────────────────────────────────────────────
  {
    ...
    capabilities: { translation: 'none', liveMode: false, diarization: true, languageCount: 51 },
    roles: ['main'],
    requiresRuntime: 'cuda',
  },
  {
  ...
  // beats the 1.1b on all English benchmarks.
  {
    ...
    capabilities: { translation: 'none', liveMode: false, diarization: true, languageCount: 25 },
    roles: ['main'],
  },
  ...
  // ── Diarization ──────────────────────────────────────────────────────────
  {
    ...
    capabilities: { translation: 'none', liveMode: false, diarization: true, languageCount: 0 },
    roles: ['diarization'],
    requiresRuntime: 'cuda',
  },
];
