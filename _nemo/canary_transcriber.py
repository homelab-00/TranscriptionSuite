...
class CanaryTranscriber:
    ...
    SUPPORTED_LANGUAGES = [
        "en", "de", "es", "fr", "hi", "ja", "ko", "pt", "zh",
        "ar", "cs", "el", "fi", "hu", "it", "nl", "no", "pl",
        "ro", "ru", "sv", "tr", "uk", "vi",
    ]
    ...
    def load_model(self) -> None:
        ...
        try:
            ...
            if self.device == "cuda" and torch.cuda.is_available():
                ...
                logger.info(f"Model loaded on CUDA device: {torch.cuda.get_device_name(0)}")
            else:
        ...
        try:
            ...
            if duration > self.MAX_SINGLE_PASS_SECS:
                ...
                text = self._transcribe_chunked(
                    audio_data, sample_rate, lang, pnc
                )
            else:
                # Short audio - single pass
                text = self._transcribe_single(
                    str(audio_path), lang, pnc
                )
    ...
    def _merge_transcripts(self, transcripts: List[str]) -> str:
        ...
        for i in range(1, len(transcripts)):
            ...
            # This is a simple heuristic - look for common ending/beginning
            ...
            if prev_words and curr_words:
                ...
                for overlap_len in range(min(5, len(prev_words), len(curr_words)), 0, -1):
                    ...
                    if prev_end == curr_start:
                        ...
                        overlap_found = True
                        logger.debug(f"Found {overlap_len}-word overlap at chunk boundary")
                        break
